...
from plexe.internal.models.tools.training import get_generate_training_code, get_fix_training_code
...
class ModelTrainerAgent:
    ...
    def __init__(
        ...
        self.agent = ToolCallingAgent(
            ...
            tools=[
                get_generate_training_code(tool_model_id),
                validate_training_code,
                get_fix_training_code(tool_model_id),
