...
from plexe.internal.common.utils.chain_of_thought.emitters import ChainOfThoughtEmitter, MultiEmitter
...
class PlexeUI:
    ...
    def handle_message(self, message: str, history: List[List[str]]) -> tuple:
        """
        ...
        try:
            ...
            # Log the user message to the chain of thought
            self.emitter.emit_thought("User", f"Message: {message}")
            ...
            self.emitter.emit_thought("System", f"Response complete")
    ...
    def update_cot(self, logs: str) -> str:
        """
